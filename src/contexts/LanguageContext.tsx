...
const translations: Record<Language, Translations> = {
  el: {
    ...
    hero: {
      welcome: "Καλώς ήρθατε στον σταθμό μας!",
      title1: "Χρώματα",
      title2: "& Γέλια",
      description: "Ένας χαρούμενος παιδικός σταθμός και νηπιαγωγείο όπου τα παιδιά ανακαλύπτουν τον κόσμο μέσα από το παιχνίδι, τη δημιουργικότητα και την αγάπη.",
      cta: "Γνωρίστε μας",
      contact: "Επικοινωνία",
      experience: "χρόνια",
      years: "εμπειρίας",
    ...
    contact: {
      ...
      email: "Email",
      hours: "Ωράριο",
      addressDetails: ["Αγαμέμνονος 8 και Βενεζουέλας", "166 74 Γλυφάδα"],
      phoneDetails: ["210 9623976", "697 0250350", "697 8902434"],
  ...
  en: {
    ...
    hero: {
      welcome: "Welcome to our daycare center!",
      title1: "Colors",
      title2: "& Laughter",
      description: "A joyful daycare and kindergarten where children discover the world through play, creativity and love.",
      cta: "Meet us",
      contact: "Contact",
      experience: "years of",
      years: "experience",
    ...
    contact: {
      ...
      email: "Email",
      hours: "Hours",
      addressDetails: ["Agamemnonos 8 & Venezuelas", "166 74 Glyfada, Greece"],
      phoneDetails: ["+30 210 9623976", "+30 697 0250350", "+30 697 8902434"],
